...
bech32_templates = [
  ...
  ('oxc',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('oxc',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('oxc',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('toxc',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('toxc',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('toxc',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('roxc',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('roxc',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('roxc', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('toxc',  17, 32, False, False, False),
  ('roxc',  3,  1, False, False, False),
  ('oxc',   15, 41, False, False, False),
  ('toxc',  0, 16, False, False, False),
  ('roxc',  0, 32, True,  False, False),
  ('oxc',   0, 16, True,  False, False),
  ('toxc',  0, 32, False, True,  False),
  ('roxc',  0, 20, False, False, True)
]
