Oxedcoin Core version *0.15.1* is now available from:

  <https://download.oxedcoin.org/oxedcoin-0.15.1/>
...
A number of changes to the way Oxedcoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 oxes per kB (0.00001 OXC). This is to prepare for dropping the minimum transaction fee to 0.1 oxes per kB (0.0001 OXC) in the next release.
