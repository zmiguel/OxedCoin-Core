# Support for Output Descriptors in Oxedcoin Core

Since Oxedcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `oxc1...` for mainnet or `toxc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Oxedcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Oxedcoin Core wallets, a convenience function `combo` is
