...
"""Verify that starting oxedcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start oxedcoin with -h for help text")
        ...
        self.log.info("Start oxedcoin with -version for version information")
        ...
        self.log.info("Start oxedcoind with -fakearg to make sure it does not start")
