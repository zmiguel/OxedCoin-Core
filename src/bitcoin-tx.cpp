...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " oxedcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  oxedcoin-tx [options] <hex-tx> [commands]  Update hex-encoded oxedcoin transaction\n" +
            "or:     oxedcoin-tx [options] -create [commands]   Create hex-encoded oxedcoin transaction\n" +
            "\n";
