...
const char * const BITCOIN_CONF_FILENAME = "oxedcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Oxedcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Oxedcoin";
#else
    // Unix
    return pathRet / ".oxedcoin";
#endif
#endif
}
